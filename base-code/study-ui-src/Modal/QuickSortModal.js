...
import QuickSortCode from "../Code/QuickSortCode";
...
export default function QuickSortModal({ open, onClose, arr, darkMode, theme }) {
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          퀵 정렬 <span style={{ fontSize: 26, color: textColor, fontWeight: 700, letterSpacing: 1 }}>(Quick Sort)</span>
        </div>
        {/* 설명 영역 */}
        <div style={{
          margin: "0 0 20px 0",
          ...
          <span style={{ fontSize: 16.5 }}>
            대용량 데이터, 평균적으로 매우 빠른 정렬<br/>
            <span style={{ color: darkMode ? '#ff8a65' : '#b71c1c', fontWeight: 600 }}>최악의 경우 O(n^2), 불안정 정렬</span>
          </span>
        </div>
        {/* 초기 배열 영역 */}
        <div style={{
        ...
        <div style={{
          ...
          <QuickSortAnimation arr={arr} darkMode={darkMode} theme={theme} />
        </div>
        {/* 코드 영역 */}
        <div style={{
          width: "100%",
