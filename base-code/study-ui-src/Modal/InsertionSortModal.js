...
import InsertionSortCode from "../Code/InsertionSortCode";
import InsertionSortAnimation from "../Animation/InsertionSortAnimation";
import useModalBodyScrollLock from '../hooks/useModalBodyScrollLock';

export default function InsertionSortModal({ open, onClose, arr, darkMode, theme }) {
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          삽입 정렬 <span style={{ fontSize: 26, color: textColor, fontWeight: 700, letterSpacing: 1 }}>(Insertion Sort)</span>
        </div>
        {/* 설명 영역 */}
        <div style={{
          margin: "0 0 20px 0",
        ...
        {/* 그래프 시각화 - InsertionSortAnimation */}
        <div style={{
          width: "100%",
          minHeight: 340,
          ...
          <InsertionSortAnimation arr={arr} darkMode={darkMode} theme={theme} />
        </div>
        {/* 코드 영역 */}
        <div style={{
          width: "100%",
